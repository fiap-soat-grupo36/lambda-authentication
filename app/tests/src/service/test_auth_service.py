...
class TestAuthService:
    ...
    def test_autenticar_cliente_fluxo_completo(self, mock_validador, mock_repo, mock_jwt):
        # 1. Mock Validador
        cpf_input = "123"
        mock_validador.validar_cpf.return_value = "123_limpo"

        cliente_mock = ClienteModel(id=1, cpf="123_limpo", nome="Maria", ativo=True)
        ...
        # Execução
        resposta = AuthService.autenticar_cliente(cpf_input, "secret", "region")
    ...
    def test_erro_cliente_inativo(self, mock_validador, mock_repo):
        ...
        cliente_inativo = ClienteModel(id=1, cpf="123", nome="Maria", ativo=False)
